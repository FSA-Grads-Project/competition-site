...
import { LeaderboardMainDiv, Header, Intro, MainDiv , TopScoreDiv, TableRow, LeaderboardTable, TableHeader, LeftTableCell, RightTableCell, TableRowGroup, LeftTableCellHeader, RightTableCellHeader } from '../StyledComponents/LeaderboardStyles.tw';
...
const Leaderboard = () => {
    ...
    const getTopScores = (resArr) => {
        ...
        for(const res of resArr){
            ...
            topScoreUser.username = users.find(user => user.id === res.id*1).username;
             ...
             <MainDiv>
                    {
                        scores.map(score => {
                            return (
                                   ...
                                   <TopScoreDiv key={score.id} onClick={ showResults }>  { score.username }...............................................{ score.score }
                                     ...
                                     <TableRow>
                                        <LeftTableCell> TOTAL TIME TO SOLVE: { score.timeElapsed }  minutes  </LeftTableCell>
                                        <RightTableCell> { Math.ceil(Math.random() * 10) } </RightTableCell>
